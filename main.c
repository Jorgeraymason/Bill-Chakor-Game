...
int main()
{
    int input; // Input variable for user input

    // Char for ASCII art of Bill Chakor
...
// 1st chapter of the game, introduces Newt Manson on screen as well.
void chapter1ReptillianAuthority()
{
    ...
    // Char for ASCII art of Newt Manson
